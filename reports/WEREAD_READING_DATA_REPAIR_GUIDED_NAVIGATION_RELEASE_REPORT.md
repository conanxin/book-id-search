...
- **final_release_commit**: `a2f7bc982119a4aa27bba3d589d3ca80bf855f8c`（**这是 tag 指向的 commit**）
- **provenance_update_commit**: `aa1d48b617f8c6627ff0881e47a1a16c0e7bc522`（tag 创建之后追加的 provenance 字段回填；不影响 tag target）
- 三者关系：`final_release_commit = tag target = a2f7bc9`；`provenance_update_commit = aa1d48b` 是 post-tag 的报告回填 commit。
