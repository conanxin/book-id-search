...
class Env:
 def __init__(self):
  ...
  self.r0=self.root/'r0.env'; self.r0.write_text('\n'.join(['R0_FINAL=PASS','WEB_CID=w1','WEB_STARTED_AT=wt','WEB_IMAGE_ID=wi','WEB_REVISION='+'d'*40,'API_CID=a1','API_STARTED_AT=at','API_IMAGE=book-id-search-api:old','API_IMAGE_ID=oldai','API_REVISION='+'e'*40,'MEILISEARCH_CID=m1','MEILISEARCH_STARTED_AT=mt','MEILISEARCH_IMAGE_ID=mi','PUBLIC_HTTP_STATUS=200'])+'\n')
  ...
  self.cap=self.root/'r4-cap.env'; self.cap.write_text('CAPACITY_GATE=PASS_PREFERRED\n')
